module "wrapper" {
  ...
  create_file_system_security_group               = try(each.value.create_file_system_security_group, var.defaults.create_file_system_security_group, true)
  ...
  file_system_security_group_description          = try(each.value.file_system_security_group_description, var.defaults.file_system_security_group_description, null)
  file_system_security_group_egress_rules         = try(each.value.file_system_security_group_egress_rules, var.defaults.file_system_security_group_egress_rules, {})
  file_system_security_group_ingress_rules        = try(each.value.file_system_security_group_ingress_rules, var.defaults.file_system_security_group_ingress_rules, {})
  file_system_security_group_name                 = try(each.value.file_system_security_group_name, var.defaults.file_system_security_group_name, null)
  file_system_security_group_tags                 = try(each.value.file_system_security_group_tags, var.defaults.file_system_security_group_tags, null)
  file_system_security_group_use_name_prefix      = try(each.value.file_system_security_group_use_name_prefix, var.defaults.file_system_security_group_use_name_prefix, true)
  file_system_security_group_vpc_id               = try(each.value.file_system_security_group_vpc_id, var.defaults.file_system_security_group_vpc_id, null)
  file_systems                                    = try(each.value.file_systems, var.defaults.file_systems, {})
