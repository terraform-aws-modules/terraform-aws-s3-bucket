module "wrapper" {
  ...
  access_log_delivery_policy_source_org_id    = try(each.value.access_log_delivery_policy_source_org_id, var.defaults.access_log_delivery_policy_source_org_id, null)
  access_log_delivery_policy_source_org_paths = try(each.value.access_log_delivery_policy_source_org_paths, var.defaults.access_log_delivery_policy_source_org_paths, [])
