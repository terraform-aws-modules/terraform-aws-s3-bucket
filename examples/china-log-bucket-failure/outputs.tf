...
output "s3_bucket_bucket_domain_name" {
  ...
  value       = module.log_bucket.s3_bucket_bucket_domain_name
}
...
output "s3_bucket_lifecycle_configuration_rules" {
  ...
  value       = module.log_bucket.s3_bucket_lifecycle_configuration_rules
}

output "s3_bucket_policy" {
  description = "The policy of the bucket, if the bucket is configured with a policy. If not, this will be an empty string."
  value       = module.log_bucket.s3_bucket_policy
}
...
output "s3_bucket_website_endpoint" {
  ...
  value       = module.log_bucket.s3_bucket_website_endpoint
}

output "s3_bucket_website_domain" {
  description = "The domain of the website endpoint, if the bucket is configured with a website. If not, this will be an empty string. This is used to create Route 53 alias records. "
  value       = module.log_bucket.s3_bucket_website_domain
}
