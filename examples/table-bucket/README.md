...
| Name | Source | Version |
| ---- | ------ | ------- |
| <a name="module_caller_supplied_policy"></a> [caller\_supplied\_policy](#module\_caller\_supplied\_policy) | ../../modules/table-bucket | n/a |
| <a name="module_disabled"></a> [disabled](#module\_disabled) | ../../modules/table-bucket | n/a |
| <a name="module_kms"></a> [kms](#module\_kms) | terraform-aws-modules/kms/aws | ~> 4.0 |
| <a name="module_merged_policy_documents"></a> [merged\_policy\_documents](#module\_merged\_policy\_documents) | ../../modules/table-bucket | n/a |
...
| [aws_iam_policy_document.table_bucket](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
| [aws_iam_policy_document.table_bucket_override](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
