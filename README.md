...
| <a name="input_access_log_delivery_policy_source_org_id"></a> [access\_log\_delivery\_policy\_source\_org\_id](#input\_access\_log\_delivery\_policy\_source\_org\_id) | (Optional) AWS Organization ID should be allowed to deliver access logs to this bucket. | `string` | `null` | no |
| <a name="input_access_log_delivery_policy_source_org_paths"></a> [access\_log\_delivery\_policy\_source\_org\_paths](#input\_access\_log\_delivery\_policy\_source\_org\_paths) | (Optional) AWS Organization paths should be allowed to deliver access logs to this bucket. | `list(string)` | `[]` | no |
