...
| <a name="input_policy_cloudtrail_log_prefix"></a> [policy\_cloudtrail\_log\_prefix](#input\_policy\_cloudtrail\_log\_prefix) | (Optional) Set the log prefix for the CloudTrail log delivery policy attached | `string` | `""` | no |
| <a name="input_policy_cloudtrail_source_arn"></a> [policy\_cloudtrail\_source\_arn](#input\_policy\_cloudtrail\_source\_arn) | (Optional) Set the CloudTrail ARN as source for the CloudTrail log delivery policy attached | `string` | `""` | no |
| <a name="input_policy_elb_log_prefix"></a> [policy\_elb\_log\_prefix](#input\_policy\_elb\_log\_prefix) | (Optional) Set the log prefix for the ELB log delivery policy attached | `string` | `""` | no |
| <a name="input_policy_lb_log_prefix"></a> [policy\_lb\_log\_prefix](#input\_policy\_lb\_log\_prefix) | (Optional) Set the log prefix for the ALB/NLB log delivery policy attached | `string` | `""` | no |
