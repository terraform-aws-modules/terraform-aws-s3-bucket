...
| <a name="input_restrict_log_delivery_policies"></a> [restrict\_log\_delivery\_policies](#input\_restrict\_log\_delivery\_policies) | Restrict the log delivery policies for this bucket. | `bool` | `false` | no |
