...
| <a name="input_attach_inventory_destination_policy"></a> [attach\_inventory\_destination\_policy](#input\_attach\_inventory\_destination\_policy) | Controls is S3 bucket should be the inventory destination bucket | `bool` | `false` | no |
