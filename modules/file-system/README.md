...
| <a name="input_security_groups"></a> [security\_groups](#input\_security\_groups) | Security groups added to every mount target, alongside the group this module creates | `list(string)` | `[]` | no |
